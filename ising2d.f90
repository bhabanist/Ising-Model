...
contains
    ...
    subroutine ising(beta, s, n, hit, ne)
        ...
        do i = 1, n
            ...
            if(rnd2(i) < exp(-dble(ds)*beta)) then
...
program ising2d
    ...
    integer :: n1=50, n2=50, nbeta=100
    integer :: init=0, therm=1000, inter=10, niter=200000
    integer :: n, i, j, nb
    open(10, file='output_b_d_50_0.6.txt')
    n=n1*n2
    allocate (s(n), ne(n,4))
